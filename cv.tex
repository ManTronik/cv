...
\usepackage[top=1.0cm, bottom=2.0cm, left=1.6cm, right=0.8cm]{geometry}
...
\homepage{github.com/ManTronik/cv/blob/manu/cv.pdf}
...
\textit{\large "faire plus simple et ensemble"}
...
\item \textbf{accélérer le déploiement du dual-stack au sein des infrastructures PFC }
  \begin{itemize}
   ...
   \item certifié Yellow Belt en juillet 2024 , sujet amélioration de la qualité de données dans l'IPAM Grapa  \newline
\end{itemize}
\end{itemize}
}
...
\cventry{2013\\à 2016}{Technical Design Authority}{}{entité Orange Cloud For Business - Paris 17\up{ème} }{}{
\begin{itemize}%
\item \textbf{responsable du design} d'un cloud publique Flexible Computing Advanced sur Hong Kong et Singapour ( opex/capex 15M€ euros ) 
  \begin{itemize}%
   ...
   \item certification Togaf (level 1) et certifié Overall Architect (Orange IMT) en 2015    \newline
\end{itemize}
\end{itemize}}

\cventry{2011\\à 2013}{Support avant-vente offre cloud}{}{entité Orange Cloud for Business - Paris 17\up{ème} }{}{
\begin{itemize}%
